public class p2EqualOverride {
    public static void main(String[] args) {
        ...
        //ek print statement aayega idhar hashCode ke liye
    }
}
class Car {
    ...
    public boolean equals(Object o) {
        if(o instanceof Car) {
            Car car = (Car) o;
        if(car.getBrand() == this.getBrand() && car.getModel() == this.getModel() && car.getRegistrationNumber() == this.getRegistrationNumber()){
        return true;
        }
        else{
            return false;
